...
`output/pdf/the-shape-between.pdf`, writes the deterministic inspection sheet
to `output/figures/storybook_contact_sheet.png`, and writes manifest files under
